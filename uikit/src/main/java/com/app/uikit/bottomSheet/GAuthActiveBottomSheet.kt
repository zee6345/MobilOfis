...
@Composable
private fun GAuthActiveBottomShee(navController: NavController) {
...
//                    color = Color(0xFF203657),
    ...
    GAuthActiveBottomSheet(aboutBankState){
...
@Composable
fun GAuthActiveBottomSheet(aboutBankState: MutableState<Boolean>, onClick:()->Unit) {
        ...
        Column() {
            Row(
                ...
                Box(
                    ...
                    Text(
                        text = stringResource(R.string.google_auth_activate),
