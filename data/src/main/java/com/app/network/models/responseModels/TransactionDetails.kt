...
data class TransactionDetails(
    ...
    val BENEFACC: String,
    val BENEFADDR: String,
    val BENEFBANKADDR: String,
    val BENEFBANKCODE: String,
    val BENEFBANKNAME: String,
    val BENEFNAME: String,
    val BENEFTAXID: String,
    val BICINPUTTYPE: String,
    ...
    val INFOTOBENEF: String,
    val INTERMEDBANKADDR: String,
    val INTERMEDBANKCODE: String,
    val INTERMEDBANKNAME: String,
    val NOTE: String,
    val PDF_LIST: List<FileDetails>,
    val PMTCUSTID: String,
    val PMTDET: String,
    val PMTID: String,
    val PMTSYSTEMTYPE: Any,
    val PMTTYPECODE: Any,
    val SIGNNUM: Int,
